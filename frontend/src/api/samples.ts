...
export function batchCreateSamples(data: any) { return request.post('/v1/samples/batch-register/', data) }
...
export function getRetentionSamples(params?: any) { return request.get('/v1/samples/retention-list/', { params }) }
